    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          Revolutionizing AI startups with powerful content that converts and campaigns that captivate. At WSDM Studios, we craft impactful and engaging long form Explainer Content, UGC for Social Media Content, Growth strategies to make your AI tools irresistible. Let’s break down complexity, build trust, and supercharge your brand’s reach.
